defmodule Mine.Http.WebsocketTest do
  ...
  test "win" do
    ...
    assert_ws_json_receive %{"type" => "hiscore", "position" => 1, "top_list" => "<table " <> _}, 500
  ...
  test "toggle pause" do
    ...
    send_ws_json(pid, %{"type" => "toggle-pause"})
    assert_ws_json_receive %{"type" => "draw", "flags" => 0, "score" => "3.996", "html" => "<table id='game_id'><tr></tr></table>"}
